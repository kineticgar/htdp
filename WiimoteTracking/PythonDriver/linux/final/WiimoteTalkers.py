...
class Double_Talker:
	...
	def __init__(self,address1, address2):
		...
		self.wm1 = WMManager( address1 ) # Handles the Wiimote; connects to it, manages wiimote state and mode, parses wiimote reports
		self.wm2 = WMManager( address2 ) # second wiimote
...
class Single_Talker:
	...
	def __init__(self,address):
		...
		## Create a manager for them. Handles the Backend for the wiimotes.
		self.wm1 = WMManager( address ) # Handles the Wiimote; connects to it, manages wiimote state and mode, parses wiimote reports
